/* Całkowanie równania Schrodingera (przypadek dwuwymiarowy; model 2a -- metoda dwustopniowa jawna z wykorzystaniem wzoru dziewięciopunktowego na laplasjan) */
/* Obserwacja: metoda niestabilna dla dt>0.01 przy dx==1 (podobnie jak dla wzoru pięciopunktowego) */
...
int main(void) {
	...
	char psi_nazwa[] = "schrod_2s_2d_9p.dat";	/* nazwa pliku z wartościami funkcji falowej */
